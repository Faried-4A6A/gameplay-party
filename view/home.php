        ...
        <div class="row">
          <div class="col-lg-12 text-center">
              <div class="jumbotron mt-5" style="opacity: 0.69;filter: alpha(opacity=50);">
                      ...
                      <hr class="my-4">
                      <p class="lead">
                        <a class="btn btn-lg" style="background-color:#A3CB38; color:#009432;" href="http://localhost/overzichtController/overzicht" role="button">Bekijk de bioscopen</a>
                      </p>
              </div>
...
<div class="container">
  ...
  <div class="row">
      <div class="col-sm-5 col-md-6"><img src="https://via.placeholder.com/650x450?text=bedrijfsFoto" width="650" height="450" alt="..." class="img-thumbnail"></div>
